...
var Slider = __webpack_require__(78);
var Carousel = __webpack_require__(80);
...
var Home = function (_React$Component) {
    ...
    function Home() {
        ...
        _this.activateSlide = _this.activateSlide.bind(_this);
        _this.state = { selectSlide: "slide1" };
        return _this;
    }

    _createClass(Home, [{
        key: 'activateSlide',
        value: function activateSlide(cible) {
            this.setState({
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(Slider, { slideActif: this.state.selectSlide }),
                React.createElement(Carousel, { handleSlideActive: this.activateSlide })
            );
        }
    }]);
...
var Slide = __webpack_require__(79);
...
var Slide = function (_React$Component) {
    ...
    _createClass(Slide, [{
        ...
        value: function render() {
            return React.createElement(
                "li",
                { className: this.props.liClass },
                React.createElement(
                    "div",
                    { className: "flex_caption1" },
                    React.createElement(
                        "p",
                        { className: this.props.classPar1 },
                        this.props.city
                    ),
                    React.createElement(
                        "p",
                        { className: this.props.classPar2 },
                        this.props.title
                    ),
                    React.createElement(
                        "p",
                        { className: this.props.classPar3 },
                        this.props.year
                    ),
                    React.createElement(
                        "p",
                        { className: this.props.classPar4 },
                        this.props.desc
                    )
                )
            );
...
var CarouselSlide = __webpack_require__(81);
...
var Carousel = function (_React$Component) {
    ...
    _createClass(Carousel, [{
        key: 'checkActiveCarouselSlide',
        value: function checkActiveCarouselSlide(clickedSlide) {
...
var CarouselSlide = function (_React$Component) {
    ...
    function CarouselSlide() {
        ...
        var _this = _possibleConstructorReturn(this, (CarouselSlide.__proto__ || Object.getPrototypeOf(CarouselSlide)).call(this));
